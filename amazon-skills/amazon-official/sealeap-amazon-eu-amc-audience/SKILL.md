...
阅读 [references/source-and-guardrails.md](references/source-and-guardrails.md) 获取完整信源、证据等级和内容限制。处理旺季与无代码受众时再读 [references/peak-audience-course.md](references/peak-audience-course.md)。
