---
name: sealeap-zhuque-amazon-product-research-roas
description: "聚焦ROAS、季节性、竞价策略的 Amazon 选品与产品开发。在需要验证购买需求、直接竞争、差异化和单位经济，形成进入、有限验证或暂缓的有据判断时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 选品与产品开发：ROAS、季节性、竞价策略

## 目标

围绕ROAS、季节性、竞价策略，验证购买需求、直接竞争、差异化和单位经济，形成进入、有限验证或暂缓的有据判断。
