---
name: sealeap-zhuque-amazon-ad-diagnostics-shipping
description: "聚焦发货与入库、TACOS、库存管理的 Amazon 广告诊断与实验。在需要区分流量、零售承接和经济性问题，形成有样本依据的调整建议及受控实验时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 广告诊断与实验：发货与入库、TACOS、库存管理

## 目标

围绕发货与入库、TACOS、库存管理，区分流量、零售承接和经济性问题，形成有样本依据的调整建议及受控实验。
...
完整的 16 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；5 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
