---
name: sealeap-zhuque-amazon-ad-diagnostics-budget
description: "聚焦预算分配、竞价策略、匹配方式的 Amazon 广告诊断与实验。在需要区分流量、零售承接和经济性问题，形成有样本依据的调整建议及受控实验时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 广告诊断与实验：预算分配、竞价策略、匹配方式

## 目标

围绕预算分配、竞价策略、匹配方式，区分流量、零售承接和经济性问题，形成有样本依据的调整建议及受控实验。
