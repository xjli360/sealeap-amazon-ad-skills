---
name: sealeap-zhuque-amazon-policy-monitoring
description: "聚焦关键词体系、卖家精灵、季节性的 Amazon 平台政策与异常监控。在需要核对官方规则、时间和适用范围，形成影响清单、应对动作与复核节点时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 平台政策与异常监控：关键词体系、卖家精灵、季节性

## 目标

围绕关键词体系、卖家精灵、季节性，核对官方规则、时间和适用范围，形成影响清单、应对动作与复核节点。
...
完整的 6 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；1 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
