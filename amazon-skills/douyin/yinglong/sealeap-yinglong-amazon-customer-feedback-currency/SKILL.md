---
name: sealeap-yinglong-amazon-customer-feedback-currency
description: "聚焦汇率风险、季节性、品牌与备案的 Amazon 客户反馈与转化改进。在需要从评论、退货和客服证据定位购买障碍，形成产品或页面改进的优先级和验证计划时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---
...
完整的 14 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；5 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
