---
name: sealeap-yinglong-amazon-account-compliance-tax
description: "聚焦税务与出口、账户验证、运营工具的 Amazon 账户、合规与风险。在需要识别受影响账户与义务，核对通知、证据和期限，形成风险分级、纠正计划与可审核材料时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 账户、合规与风险：税务与出口、账户验证、运营工具

## 目标

围绕税务与出口、账户验证、运营工具，识别受影响账户与义务，核对通知、证据和期限，形成风险分级、纠正计划与可审核材料。
...
完整的 27 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；32 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
