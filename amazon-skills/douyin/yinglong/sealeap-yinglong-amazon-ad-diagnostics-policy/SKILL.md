---
name: sealeap-yinglong-amazon-ad-diagnostics-policy
description: "聚焦政策变化、点击表现、运营工具的 Amazon 广告诊断与实验。在需要区分流量、零售承接和经济性问题，形成有样本依据的调整建议及受控实验时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 广告诊断与实验：政策变化、点击表现、运营工具

## 目标

围绕政策变化、点击表现、运营工具，区分流量、零售承接和经济性问题，形成有样本依据的调整建议及受控实验。
...
完整的 45 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；25 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
