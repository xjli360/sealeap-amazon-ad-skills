---
name: sealeap-pixiu-amazon-brand-growth
description: "聚焦品牌与备案、图片与视频、类目与节点的 Amazon 品牌、内容与增长。在需要将购买任务和品牌事实映射到内容与渠道，形成可验证的创意简报和增长计划时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 品牌、内容与增长：品牌与备案、图片与视频、类目与节点

## 目标

围绕品牌与备案、图片与视频、类目与节点，将购买任务和品牌事实映射到内容与渠道，形成可验证的创意简报和增长计划。
...
完整的 31 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；11 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
