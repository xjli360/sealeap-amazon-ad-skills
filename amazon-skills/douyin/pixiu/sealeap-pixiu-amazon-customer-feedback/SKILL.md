---
name: sealeap-pixiu-amazon-customer-feedback
description: "聚焦评价与口碑、用户画像、新品启动的 Amazon 客户反馈与转化改进。在需要从评论、退货和客服证据定位购买障碍，形成产品或页面改进的优先级和验证计划时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---
...
完整的 38 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；19 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
