---
name: sealeap-qinglong-amazon-fba-inventory-seasonality
description: "聚焦季节性、现金流、竞品验证的 Amazon FBA、物流与库存。在需要核对可售、在途、交期和费用，量化断货与积压风险，形成可执行的库存处理方案时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon FBA、物流与库存：季节性、现金流、竞品验证

## 目标

围绕季节性、现金流、竞品验证，核对可售、在途、交期和费用，量化断货与积压风险，形成可执行的库存处理方案。
