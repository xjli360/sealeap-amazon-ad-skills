---
name: sealeap-qinglong-amazon-account-compliance-reviews
description: "聚焦评价与口碑、政策变化、客服与工单的 Amazon 账户、合规与风险。在需要识别受影响账户与义务，核对通知、证据和期限，形成风险分级、纠正计划与可审核材料时使用；根据当前业务问题选择证据卡，避免加载无关主题。"
---

# Amazon 账户、合规与风险：评价与口碑、政策变化、客服与工单

## 目标

围绕评价与口碑、政策变化、客服与工单，识别受影响账户与义务，核对通知、证据和期限，形成风险分级、纠正计划与可审核材料。
...
完整的 7 张主题证据卡见 [references/topic-cards.md](references/topic-cards.md)；2 种原有组合见 [references/scenario-patterns.md](references/scenario-patterns.md)。
